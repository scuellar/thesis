...
%To make into a tech report (thesis) uncomment (comment) the following line:
%\newcommand{\techreport}{}

%The following command allows to provide two versions of a text,
% depending on thesis or tech report. Useful to change "I" into "we" and so on.  
\newcommand{\thesisorreport}[2]{%
\ifdefined\techreport%
#2%
\else%
#1%
...
%Variables
\newcommand{\githublink}{\url{https://github.com/PrincetonUniversity/VST}}
\newcommand{\githubbranch}{\emph{new\_stutter}}
\newcommand{\githubcommit}{b1d968be5e009af5fa95429f85e52de30634ff2f}
\newcommand{\techlink}{\cite{TECHREPORT}}
...
\ifdefined\techreport
\providecommand{\maybefrontmatter}{\techreportfront}
\else
...
\ifdefined\techreport  %The authors of the tech report
\title{Compiler Correctness for Concurrency: from concurrent separation logic to shared-memory assembly language}
\usepackage{authblk}
\author{Santiago Cuellar}
\author{Nick Giannarakis}
\author[1,2]{Jean-Marie Madiot}
\author[1,3]{William Mansky}
\author{Lennart Beringer}
\author[1,4]{Qinxiang Cao}
\author{Andrew W. Appel}
\affil[1]{Princeton University}
\affil[2]{Currently at INRIA Paris}
\affil[3]{Currently at University of Illinois}
\affil[4]{Currently at Shanghai Jiao Tong University}
\else
...
\input{lib/macros}
\input{lib/moremacros}
\input{lib/theorem-envs}
...
\include{ch-topbottom/chapter-topbottom}
%\include{ch-otherparts/chapter-otherparts} %Old replaced by CSLsound + ASMproofs
\include{ch-compcert/chapter-compcert}
\include{ch-compiler/chapter-compiler}
\include{ch-CSLsound/chapter-CSLsound}
\include{ch-ASMproofs/chapter-ASMproofs}
